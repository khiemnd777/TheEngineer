...
public class BlockCreator : MonoBehaviour
{
    ...
    public void CreateBlock16x16()
    {
		...
		customBlockInstance.surfaceTexture.maker.textureWidth = 16;
		customBlockInstance.surfaceTexture.maker.textureHeight = 16;
		customBlockInstance.standardTexture.maker.textureWidth = 16;
		customBlockInstance.standardTexture.maker.textureHeight = 16;
	...
	public void CreateBlock16x32()
	{
		...
		customBlockInstance.texture.maker.textureWidth = 16;
		customBlockInstance.texture.maker.textureHeight = 32;
		customBlockInstance.SetOKCallback(textures => {
