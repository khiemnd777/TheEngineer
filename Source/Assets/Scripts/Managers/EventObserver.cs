...
public enum Events
{
    None, DragPixelStart, DragMultiplePixelsStart, DragPixel, DragMultiplePixels, CreatePixel, SelectPixel, DragToMultipleSelect, OutFocusMultipleSelect, OutFocusSelect, ShowContextMenu, HideContextMenu
}
